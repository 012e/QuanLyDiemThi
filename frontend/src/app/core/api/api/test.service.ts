...
export class TestService implements TestServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public testList(limit?: number, offset?: number, ordering?: string, search?: string, subjectId?: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<PaginatedTestList>;
    public testList(limit?: number, offset?: number, ordering?: string, search?: string, subjectId?: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<PaginatedTestList>>;
    public testList(limit?: number, offset?: number, ordering?: string, search?: string, subjectId?: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<PaginatedTestList>>;
    public testList(limit?: number, offset?: number, ordering?: string, search?: string, subjectId?: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
