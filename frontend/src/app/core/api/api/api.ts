...
export const APIS = [ApiService, AuthService, ClassService, ConfigService, DifficultyService, QuestionService, ResultsService, StudentService, StudentresultService, SubjectService, TestService, UserService];
