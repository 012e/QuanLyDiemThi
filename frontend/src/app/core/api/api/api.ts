...
export const APIS = [ApiService, AuthService, ClassService, ConfigService, DifficultyService, QuestionService, ResultsService, StudentService, SubjectService, TestService];
