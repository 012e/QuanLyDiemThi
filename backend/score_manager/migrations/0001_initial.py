# Generated by Django 5.1.1 on 2024-12-28 12:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=50, unique=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('permissions', models.ManyToManyField(related_name='roles', to='score_manager.permission')),
            ],
        ),
        migrations.AddField(
            model_name='customuser',
            name='roles',
            field=models.ManyToManyField(related_name='users', to='score_manager.role'),
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('semester', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('student', 'result'), name='unique_student_result'),
        ),
        migrations.AddConstraint(
            model_name='question',
        ...
        migrations.AddConstraint(
            model_name='result',
            constraint=models.UniqueConstraint(fields=('test', 'teacher', 'classroom'), name='unique_test_teacher_classroom'),
        ),
    ]
