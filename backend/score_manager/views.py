...
@extend_schema_view(
    list=extend_schema(
        description=(
            "Retrieve a list of students with detailed classroom information. "
            "Supports ordering by `name` and searching by `name`, `student_code`, and `classroom__name`."
        ),
        responses={
            200: {
                "type": "array",
                "items": {
                    ...
                    "properties": {
                        ...
                        "student_code": {"type": "string", "example": "STU123"},
                        "classroom": {
                            "type": "object",
                            "properties": {
                                "id": {"type": "integer", "example": 1},
                                "name": {"type": "string", "example": "Class A"},
                                "teacher": {"type": "integer", "example": 2},
                            },
                        },
                        "created_at": {
                            "type": "string",
    ...
    retrieve=extend_schema(
        description="Retrieve a single student with detailed classroom information.",
        responses={
            200: {
                "type": "object",
                "properties": {
